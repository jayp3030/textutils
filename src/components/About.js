        ...
        <div className="accordion" id="accordionExample">
            <div className="accordion-item">
                ...
                <div className="accordion-body">
                    Textutils is a user-friendly and free to use react-app.
                </div>
                </div>
            </div>
            <div className="accordion-item">
                ...
                <div className="accordion-body">
                    Textutils provies functionality to analyze your text such as word counter,character counter and time taken to read the text which is very helpful for user.
                </div>
                </div>
            </div>
            <div className="accordion-item">
